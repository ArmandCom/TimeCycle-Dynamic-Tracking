...
from utils.list_module import ListModule


class MaskedConv2d(nn.Conv2d): #BaseModule,
    """
...
class MaskedStackedConvolution(nn.Module): #BaseModule
    """
...
class Estimator2D(nn.Module): #BaseModule
    """

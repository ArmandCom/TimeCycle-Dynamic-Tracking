...
def residual_op(x, functions, parallel_functions, bns, activation_fn):
...
class UpsampleBlock(BaseBlock):
    ...
    def __init__(self, channel_in, channel_out, activation_fn, use_bn=True, use_bias=False):
        ...
        self.conv1a = nn.ConvTranspose2d(channel_in, channel_out, kernel_size=[5,1],
                                         padding=[2,1], stride=[2,1], output_padding=1, bias=use_bias).cuda()
        ...
        self.conv2a = nn.ConvTranspose2d(channel_in, channel_out, kernel_size=1,
                                         padding=0, stride=[2,1], output_padding=1, bias=use_bias).cuda()
